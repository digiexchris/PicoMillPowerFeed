...
namespace PowerFeed
{
	...
	Settings::System Settings::System::from_json(const nlohmann::json &j)
	{
		...
		s.settingsAutoSaveDelayMs = j["SETTINGS_AUTO_SAVE_DELAY_MS"].get<uint32_t>();
		s.version = j["SETTINGS_VERSION"].get<std::string>();
		return s;
	}
	...
	Settings Settings::from_json(const nlohmann::json &j)
	{
		...
		s.system = System::from_json(j["SYSTEM"]);
	...
	SettingsManager::SettingsManager() : myAutoSaveTimer(nullptr)
	{
		...
		myAutoSaveTimer = xTimerCreate(
			...
			pdMS_TO_TICKS(settings->system.settingsAutoSaveDelayMs),
	...
	void SettingsManager::SaveNow()
	{
		...
		{
			BaseType_t result = xTimerStop(myAutoSaveTimer, 0);
