...
// std::shared_ptr<::Time> iTime;

// std::shared_ptr<::StepperState> stepperState;

// std::shared_ptr<::Machine> machineState;

// std::unique_ptr<::Drivers::RP2040_HAL> hal;
...
// 	hal = std::make_unique<::Drivers::RP2040_HAL>(machineState);
